<template>
        <tr v-bind:class="{expulsion: student.order_of_expulsion.length != 0}">
            <td>{{ index + 1 }}</td>
            <td>{{ student.surname }}
                {{ student.name }}
            ...
            <td>{{ platoon.order_of_enrollment }}</td>
